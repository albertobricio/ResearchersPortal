...
class __TwigTemplate_4c5179a356650048f3b350a0bb12ce5b28b9fe150dfeaf2815e224497d4b08ff extends Twig_Template
{
...
<article";
  ...
  ";
      ...
      <div";
        ...
        ";
            // line 98
            echo t("@author_name on @date", array("@author_name" => (isset($context["author_name"]) ? $context["author_name"] : null), "@date" => (isset($context["date"]) ? $context["date"] : null), ));
            // line 99
            echo "        ";
  ...
  {% if display_submitted %}
    <footer class=\"node__meta\">
      <div{{ author_attributes.addClass('node__submitted') }}>
        {{ author_picture }}
        {% trans %} {{ author_name }} on {{ date }}{% endtrans %}
        {{ metadata }}
      </div>
    </footer>
  {% endif %}
